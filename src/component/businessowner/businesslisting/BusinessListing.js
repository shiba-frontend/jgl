    ...
    <div className="comon-layout deal-listing">
      <div className="container">
          <div className='listing-card'>
                ...
                <p><img src={LocationIcon}/> 123 XYZ Road, Bowie, MD, USA</p>
                <p><img src={phoneIcon}/> Phone: 98765433210</p>
                <div className='listing-card-btn'>
                    <NavLink to="/add-business" className="fillBtn">Edit Listing</NavLink>
                    <NavLink to="/delete-listing" className="outlinebtn">Delete Listing</NavLink>
                </div>
          </div>

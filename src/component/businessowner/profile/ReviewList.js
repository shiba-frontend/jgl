...
const ReviewList = () => {
    ...
    const GetData = async ()=>{
      ...
      await axios.post("/business-owner/get-all-business-reviews", JSON.stringify(body))
      .then((response) => {
  ...
  return (
    ...
    <div className="header-info">
      <div className="container"><img src={IMAGE.deal_icon} alt="review" /> My Reviews</div>
    </div>
    </div>
            ...
            {data&&data.map((item, index)=>{
                ...
                return (
                    ...
                    <div className='review-card-header'>
                        ...
                        <p>{item?.review_content} {item?.review_main_category}</p>
